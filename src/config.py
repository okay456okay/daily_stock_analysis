...
class Config:
    ...
    analysis_llm_retry: int = 2  # Retry count on LLM failure (e.g. network error / rate limit); failed results are NOT saved
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            analysis_llm_retry=parse_env_int(os.getenv('ANALYSIS_LLM_RETRY'), 2, field_name='ANALYSIS_LLM_RETRY', minimum=0),
