...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TREND_CHANGE_WECHAT_WEBHOOK_URL": {
        "title": "Trend Change WeChat Webhook URL",
        "description": "Dedicated WeChat Work webhook used only by crontab trend-change alerts.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ANALYSIS_LLM_RETRY": {
        "title": "Analysis LLM Retry",
        "description": "Retry count when LLM or Agent analysis calls fail; failed results are not saved to history.",
        "category": "notification",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
